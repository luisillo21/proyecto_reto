 ...
 * @author hp
 */
public class Agregar_pregunta extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String  mensaje = obj.actualizar(pregunta, respuesta, true);
            response.sendRedirect("Admin/Preguntas/Preguntas.jsp");
        } catch (Exception_Exception ex) {
            Logger.getLogger(Agregar_pregunta.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
